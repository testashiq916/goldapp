...
.table-scroll::-webkit-scrollbar-track{background:#fbeded}
.table-scroll::-webkit-scrollbar-thumb{background:#d8b0b0;border-radius:4px}
.table-scroll::-webkit-scrollbar-thumb:hover{background:#b48585}
