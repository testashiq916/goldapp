...
<div class="pills" id="pills" style="display:none">
  ...
  <span class="pill red" id="p_total"></span>
</div>
<div class="table-wrap"><table id="tbl">
  <thead><tr>
    <th>#</th><th>Date</th><th>Code</th><th>Customer Name</th>
    <th class="num">Amount</th><th>Particular</th><th>Ref Ac</th><th>SNo</th>
  </tr></thead>
...
function load(){
  ...
  fetch('/api/customers/payment-details?date1='+document.getElementById('date1').value
  ...
  .then(r=>r.json()).then(d=>{
    ...
    document.getElementById('p_total').textContent='Total: ₹'+fmt(d.total);
