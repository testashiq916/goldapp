...
(function() {
    ...
    function getEnterSequence() {
        const selectors = [
            '#depositorForm input:not([type="hidden"]):not([type="file"]):not([disabled])',
            '#depositorForm select:not([disabled])',
            '#depositorForm textarea:not([disabled])',
            '#depositorForm button:not([disabled])',
            '.btn-bar .btn:not([disabled])'
        ];
