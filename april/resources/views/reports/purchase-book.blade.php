...
<div class="toolbar">
  ...
  <div class="f-group">
    ...
    <select id="pe" class="tb-select" style="width:120px">
...
<div class="toolbar-row2">
  ...
  <div class="f-group">
    ...
    <select id="billtype" class="tb-select" style="width:130px"><option value="">-- All --</option></select>
  </div>
  <div class="sep"></div>
...
async function loadLookups(){
  try {
    const r = await fetch(SITE+'/api/purchase-book/lookups');
...
async function loadData(){
  ...
  document.getElementById('subHeader').textContent = 'From: '+document.getElementById('date1').value+' To: '+document.getElementById('date2').value + modeLabel;

  try {
    const r = await fetch(SITE+'/api/purchase-book/data?'+qs);
    const d = await r.json();
