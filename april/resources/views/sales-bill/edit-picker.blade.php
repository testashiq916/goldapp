...
<div class="card">
  ...
  <div class="card-body">
    <div class="field-group">
      ...
      <div class="input-row">
        <input type="text" id="billNo" maxlength="30" autocomplete="off" placeholder="Enter bill no..." style="text-transform:uppercase">
...
document.querySelectorAll('input[name="actionOpt"]').forEach(r => {
  r.addEventListener('change', function(){
    $('optEdit').className = 'action-option' + (this.value === 'edit' ? ' selected-edit' : '');
    $('optCancel').className = 'action-option' + (this.value === 'cancel' ? ' selected-cancel' : '');
  });
});
...
if (INIT_ACTION_MODE === 'cancel') {
  ...
  if (r) { r.checked = true; $('optEdit').className = 'action-option'; $('optCancel').className = 'action-option selected-cancel'; }
}
