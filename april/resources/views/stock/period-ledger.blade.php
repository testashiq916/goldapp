...
table{width:100%;font-size:8.2px;table-layout:fixed}
    ...
    <div class="content">
        ...
        <table>
            ...
            <tr>
                ...
                @endif
                <th class="num" style="width:55px">Op Qty</th>
                <th class="num" style="width:85px">Op Weight</th>
                @if($withStone)
                ...
                @endif
                @endif
                <th class="num" style="width:60px">Cl Qty</th>
                <th class="num" style="width:85px">Cl Weight</th>
                @if($withStone)
            ...
            <tr>
                ...
                @endif
                <td class="num">{{ $row['opqty'] ?: '' }}</td>
                <td class="num">{{ $row['opwgt'] != 0 ? number_format($row['opwgt'],3) : '' }}</td>
                @if($withStone)
                ...
                @endif
                @endif
                <td class="num" style="{{ $negCl?'color:#c0392b;font-weight:700':'' }}">{{ $row['clqty'] ?: '' }}</td>
                <td class="num" style="{{ $negCl?'color:#c0392b;font-weight:700':'' }}">
            ...
            <tr>
                <td colspan="3">Total {{ $tl }}</td>
                <td class="num">{{ $totals[$tk]['opqty'] }}</td>
                <td class="num">{{ number_format($totals[$tk]['opwgt'],3) }}</td>
                @if($withStone)
                ...
                @endif
                @endif
                <td class="num">{{ $totals[$tk]['clqty'] }}</td>
                <td class="num">{{ number_format($totals[$tk]['clwgt'],3) }}</td>
                @if($withStone)
            ...
            <tr style="background:#dde8f8">
                ...
                @endif
                <td class="num"><strong>{{ $tOpQ }}</strong></td>
                <td class="num"><strong>{{ number_format($tOpW,3) }}</strong></td>
                @if($withStone)
                ...
                @endif
                @endif
                <td class="num"><strong>{{ $tClQ }}</strong></td>
                <td class="num"><strong>{{ number_format($tClW,3) }}</strong></td>
                @if($withStone)
