...
<div class="table-wrap" id="tableWrap" style="display:none">
  <table>
    <thead>
      <tr>
        <th>Date</th><th>Doc No</th><th style="text-align:left">Party</th>
...
<div class="empty" id="emptyState">Set filters and click <strong>Show</strong> to view the sales register.</div>
</div>
<script>
const API_DATA=@json(url('/api/other-item-reports/sales-register/data'));
