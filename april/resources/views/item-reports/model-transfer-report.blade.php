...
input[type=text]{height:32px;border:1px solid #bfd0e6;border-radius:5px;padding:0 8px;font-size:12px;box-sizing:border-box;width:110px;text-transform:uppercase}
