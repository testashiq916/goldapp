    ...
    <div class="sec">
        <div class="grid4">
            ...
            <div class="field">
                ...
                <input id="discount" type="number" step="0.01" value="0" style="text-align:right;">
            </div>
        </div>
...
(() => {
    ...
    async function doSave() {
        ...
        try {
            ...
            if (!payload.pdc && (document.getElementById('chkPrintSlip').checked || document.getElementById('chkPrintObCb').checked)) {
