...
<div class="wrap">
    ...
    <div class="sec">
        <div class="grid4">
            ...
            <div class="field">
                <label>Amount</label>
                <input id="amount" type="number" step="0.01" value="0" style="text-align:right;">
            </div>
            <div style="display:flex;flex-direction:column;gap:4px;justify-content:flex-end;">
                <div class="bal-box">
                    <span class="lbl">OB:</span>
                    <span id="obVal" class="val">0.00</span>
        ...
        <div style="display:flex;gap:16px;align-items:center;margin-top:6px;">
            ...
            <div class="bal-box">
                ...
                <span id="cbVal" class="val">0.00</span>
    ...
    <div class="sec">
        <div class="grid4">
            <div class="field">
                <label>Rate</label>
                <input id="rate" type="number" step="0.01" value="0" style="text-align:right;">
            </div>
            <div class="field">
                <label>Tax %</label>
                <input id="taxperc" type="number" step="0.01" value="0" style="text-align:right;">
            </div>
            <div class="field">
                <label>Tax Amount</label>
                <input id="taxamt" type="number" step="0.01" value="0" style="text-align:right;">
            </div>
            <div class="field">
...
(() => {
    ...
    function resetForm() {
        ...
        document.getElementById('obVal').textContent = '0.00';
        document.getElementById('obLabel').textContent = '';
        document.getElementById('cbVal').textContent = '0.00';
        ...
        document.getElementById('taxperc').value = '0';
    ...
    async function updateCashBalance() {
        ...
        try {
            ...
            document.getElementById('cashBalVal').textContent = Math.abs(d.balance || 0).toFixed(2);
        } catch (e) { /* silent */ }
    }
